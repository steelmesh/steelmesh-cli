...
var MeshApp = exports.MeshApp = function(appPath, config) {
    ...
    // if we have a couchdb section, then ensure we have the couch addin
    if (this.couchdb) {
        this.addins.push('couch');
    }
};
    ...
    this.routes.forEach(function(route) {
        ...
        if (match) {
            ...
            try {
                ...
                mesh.log('Could not load module: ' + modulePath, e);
            }
        } // if
    });
